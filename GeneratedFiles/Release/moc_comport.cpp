...
QT_MOC_LITERAL(5, 37, 17), // "slotSetSendButton"
QT_MOC_LITERAL(6, 55, 19), // "soltReceStartButton"
QT_MOC_LITERAL(7, 75, 18), // "soltReceStopButton"
QT_MOC_LITERAL(8, 94, 16) // "slotReceTextArea"

    },
    "comPort\0slotSend\0\0slotSendTextArea\0s\0"
    "slotSetSendButton\0soltReceStartButton\0"
    "soltReceStopButton\0slotReceTextArea"
};
...
void comPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->slotSetSendButton(); break;
        case 3: _t->soltReceStartButton(); break;
        case 4: _t->soltReceStopButton(); break;
        case 5: _t->slotReceTextArea((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
