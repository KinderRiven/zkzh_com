...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_sendThread_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 23, 13) // "setSendButton"

    },
    "sendThread\0response\0\0s\0setSendButton"
};
...
void sendThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (sendThread::*_t)(const QString & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&sendThread::response)) {
                *result = 0;
            }
        }
        {
            typedef void (sendThread::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&sendThread::setSendButton)) {
                *result = 1;
            }
        }
    }
...
void *sendThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_sendThread.stringdata))
...
// SIGNAL 0
void sendThread::response(const QString & _t1)
{
